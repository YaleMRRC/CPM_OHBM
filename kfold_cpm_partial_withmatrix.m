function [all_r, all_p, pos_mat, neg_mat, pred_all] =  kfold_cpm_partial_withmatrix(mat, score, covar, no_fold, no_iter, thresh, type)
...
for iter = 1: no_iter;
    ...
    for fold = 1: no_fold
        ...
        [r_mat, p_mat] = partialcorr(train_data', train_score, train_covar, 'type', type);
        ...
        % pos_len = length( pos_edge);
        % neg_len = length( neg_edge);
